...
{
    public class TestEquatableData
    {
        EquatableData _target;

        EquatableData Value => new EquatableData { value = 123 };
        ...
        {
            // when
            bool actual = _target.Equals(new EquatableData { value = 987 });
        ...
        {
            object objValue = new EquatableData { value = 987 };
